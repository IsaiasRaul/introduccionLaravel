...
<!-- title -->
<label class="uppercase text-gay-700 text-sx">Título</label>
...
<!-- slug -->
<label class="uppercase text-gay-700 text-sx">Slug</label>
...
<!-- body -->
<label class="uppercase text-gay-700 text-sx">Contenido</label>
